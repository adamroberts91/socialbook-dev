...
<div class="main_column column">
    <h4 class="settings_h4">Account Settings</h4>
    <?php
    ...
    <br><br>Modify the values and click 'Update details'<br><br>
    ...
    <form action="settings.php" method="POST">
        ...
        Email Address: <input type="text" name="email" value="<?php echo $email?>" class="settings_input"><br>
        <?php echo $message; ?>
        <input type="submit" name="update_details" id="update_details" value="Update Details" class="info settings_submit"><br>
    </form>

    <h4 class="settings_h4">Change Password</h4>
    <form action="settings.php" method="POST">
        ...
        Confirm password: <input type="password" name="new_password_2" class="settings_input"><br>
        <?php echo $password_message; ?>
        <input type="submit" name="update_password" id="close_account" value="Update Password" class="info settings_submit">
    </form>

    <h4 class="settings_h4">Close Account</h4>
    <form action="settings.php" method="POST">
